...
export function ResumoCard({
  ...
  return (
    <section
      ...
      className="mt-3.5 p-5 md:py-4 md:px-6 bg-white border border-kr-deep-12 rounded-xl grid grid-cols-1 md:grid-cols-[1.4fr_1fr_1fr_1fr] gap-4 md:gap-0"
    >
